...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The function nestedFunction can access the variable internal, because both are within the function myFunction. The nested function is the "lowest" meaning that the ones above can access it. 
...
const zooAnimals = [
  ...
  */
  function animalNames(array){
    let names = [];
    array.forEach(item => names.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`));
    return names;
  }
  ...
  */
  function lowPopulationAnimals(array){
    let lowPopulationAnimals = array.filter(item => item.population < 5);
